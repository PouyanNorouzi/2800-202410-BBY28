...
app.get("/signup", (req, res) => {
  ...
  var errorStrings = [
    ...
    "Invalid Username",
    "Invalid Email",
    "Password must be 4 to 20 Characters and contain only alpha-numeric characters",
...
app.get("/login", (req, res) => {
  ...
  var errorStrings = [
    ...
    "Email does not exist <a href='/signup'>Sign Up?</a>",
    "Password is incorrect",
  ];
  res.render("login", {
    error: errorStrings[errorCode],
    tempInfo: req.session.tempInfo,
  });
});
...
app.post(
  ...
  async (req, res) => {
    ...
    if (changed == "true") {
      ...
      stream = await cloudinary.uploader.upload(
            ...
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <div class="button-container">
                        <a href="${currentUrl}/reset-password?id=${resetPassId}" class="button">Reset Password</a>
                    </div>
                ...
                <div class="footer">
                    ...
                    <p><a href=${currentUrl}/reset-password?id=${resetPassId}">${currentUrl}/reset-password?id=${resetPassId}</a></p>
                </div>
            </div>
        </body>
        </html>`,
